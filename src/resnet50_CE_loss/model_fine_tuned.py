...
# Get the current script's directory (src/resnet50_CE_loss/)
...
GALLERY_FOLDER = os.path.join(
    PROJECT_ROOT, "data", "competition", "test", "gallery")
QUERY_FOLDER = os.path.join(
    PROJECT_ROOT, "data", "competition", "test", "query")

# Path to the fine-tuned model file (stored in the same directory as this script)
FINE_TUNED_PATH = os.path.join(CURRENT_DIR, "fine_tuned_model.pth")
